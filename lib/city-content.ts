...
export const CITY_CONTENT: Record<string, CityContent> = {
  'salt-lake-city-ut': {
    overview: "Utah's capital and economic center, Salt Lake City presents unique construction opportunities across diverse neighborhoods from historic downtown to modern suburban areas. Our team understands the city's complex zoning requirements and historic preservation guidelines.",
    demographics: {
      population: 200591,
    ...
    localChallenges: [
      {
        ...
        solution: 'Our certified historic renovation specialists ensure compliance with preservation standards',
    ...
    testimonials: [
      {
        ...
        service: 'Historic Home Renovation',
        quote: 'Wildwest Construction perfectly preserved our 1920s home character while adding modern amenities.',
        rating: 5,
        projectValue: 85000,
    ...
    buildingCodes: {
      ...
      commonRequirements: ['Seismic compliance', 'Historic district approval', 'Energy efficiency standards'],
  ...
  'west-valley-city-ut': {
    overview: "West Valley City is Utah's second-largest city, featuring diverse residential communities and growing commercial districts. Our team specializes in both new construction and renovation projects throughout this dynamic suburban area.",
    demographics: {
      population: 140230,
  ...
  'west-jordan-ut': {
    overview: "West Jordan combines family-friendly neighborhoods with growing commercial areas. Our construction services support both residential improvements and new commercial development in this thriving Salt Lake County community.",
    demographics: {
      population: 116961,
    ...
    localChallenges: [
      {
        ...
        solution: 'Strong relationships with local utility companies for efficient project completion',
    ...
    testimonials: [
      {
        ...
        quote: 'Our family room addition exceeded expectations. Professional work from start to finish.',
        rating: 5,
        projectValue: 62000,
  ...
  'sandy-ut': {
    overview: "Sandy sits at the base of the Wasatch Mountains, offering unique construction challenges and opportunities. From historic downtown to modern residential areas, our team handles projects ranging from mountain home construction to urban renovations.",
    demographics: {
      population: 96904,
    ...
    neighborhoods: [
      ...
      },
      {
        ...
        popularServices: ['Historic Renovation', 'Downtown Loft Conversion', 'Commercial Renovation']
      }
    ],
    landmarks: [
      {
    ...
    buildingCodes: {
      ...
      specialConsiderations: ['Hillside construction', 'View preservation', 'Drainage requirements']
    },
    serviceAreas: {
  ...
  'draper-ut': {
    overview: "Draper represents some of Utah's most exclusive residential communities, nestled in the foothills with stunning mountain and valley views. Our premium construction services cater to discerning homeowners seeking luxury and quality.",
    demographics: {
      population: 51017,
    ...
    neighborhoods: [
      {
        ...
        popularServices: ['Luxury Home Construction', 'View Deck Installation', 'Hillside Stabilization']
      },
      {
        name: 'South Mountain',
        slug: 'south-mountain',
    ...
    buildingCodes: {
      ...
      commonRequirements: ['Architectural review board approval', 'Hillside development standards', 'Premium construction standards'],
  ...
  'murray-ut': {
    overview: "Murray is centrally located in Salt Lake County, offering a perfect blend of established neighborhoods and modern developments. Our construction services range from historic home renovations to contemporary commercial projects.",
    demographics: {
      population: 49205,
    ...
    landmarks: [
      {
        ...
        nearbyProjects: ['Retail Renovations', 'Restaurant Build-outs', 'Parking Structure Maintenance']
      }
    ],
    testimonials: [
      {
    ...
    buildingCodes: {
      ...
      commonRequirements: ['Standard building codes', 'Historic district compliance', 'Commercial zoning requirements'],
