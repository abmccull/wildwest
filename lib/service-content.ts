...
const serviceContentData: ServiceContentData[] = [
  {
    ...
    metaDescription:
      'Professional residential roofing installation, repair, and replacement services in Utah. Licensed, insured, and warranty-backed roofing solutions.',
    keywords: [
      'residential roofing',
      'roof installation',
      'roof repair',
...
Weather emergencies don't wait for convenient times, which is why we offer emergency roofing services for storm damage, leaks, and other urgent situations. Our rapid response team can provide temporary solutions to prevent further damage while developing a comprehensive repair plan.`,
    shortDescription:
      'Expert residential roofing services including installation, repair, and replacement with premium materials and warranty protection.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'We conduct a comprehensive roof inspection, documenting current conditions, identifying issues, and assessing structural integrity.',
        duration: '1-2 hours',
      },
      {
        step: 2,
        ...
        description:
          'We provide a detailed written estimate including materials, labor, timeline, and warranty information, along with material samples.',
      ...
      },
      {
        ...
        description:
          'We handle all necessary permits and prepare your property with protective measures for landscaping and belongings.',
        duration: '1-3 days',
      },
      {
        step: 4,
        ...
        description:
          'Our certified crew removes old materials and installs your new roof using industry-best practices and quality materials.',
        duration: '1-3 days',
      },
      {
        step: 5,
        ...
        description:
          'We conduct a thorough final inspection, complete cleanup with magnetic sweeps, and provide warranty documentation.',
        duration: 'Half day',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          'Most residential roof replacements take 1-3 days, depending on the size of your home, complexity of the roof design, weather conditions, and chosen materials. We provide a specific timeline during the estimate process.',
        category: 'timeline',
      },
      {
        question: "What roofing materials work best in Utah's climate?",
        answer:
          "Asphalt shingles, metal roofing, and concrete tiles all perform well in Utah. We recommend materials based on your home's architecture, budget, and specific location considerations like wind exposure and snow load requirements.",
        category: 'materials',
      },
      {
        question: 'Do you handle insurance claims for storm damage?',
        answer:
          'Yes, we work directly with insurance companies to streamline the claims process. We provide detailed documentation, meet with adjusters, and ensure all covered damage is properly addressed in your claim.',
        category: 'insurance',
      },
      {
        question: 'What warranty coverage do you provide on roofing work?',
        answer:
          'We offer comprehensive warranties including manufacturer material warranties (up to 50 years) and our workmanship warranty (up to 25 years). All warranty terms are clearly outlined in your contract.',
        category: 'warranty',
      },
      {
        question: 'Can you install solar panels on my new roof?',
        answer:
          "Absolutely. We coordinate with certified solar installers and can prepare your roof structure for solar panel installation. It's most cost-effective to plan for solar during the roofing project.",
        category: 'solar',
      },
      {
        question: 'How do I know if I need roof repair or full replacement?',
        answer:
          'Factors include age of roof, extent of damage, frequency of repairs needed, and cost-effectiveness. We provide honest assessments and explain all options, so you can make an informed decision.',
        category: 'assessment',
      },
      {
        question: 'Do you offer financing options for roofing projects?',
        answer:
          'Yes, we partner with reputable lenders to offer competitive financing options with flexible terms. We can help you find a payment plan that fits your budget.',
        category: 'financing',
      },
    ],
    callToActions: [
      ...
      },
      {
        ...
        description:
          'Get a comprehensive roof assessment with no obligation and detailed written report.',
      },
      {
        type: 'estimate',
        text: 'Get Your Free Roofing Estimate',
        description:
          'Receive a detailed quote for your roofing project with material samples and warranty information.',
      },
    ],
    relatedServices: [
      'gutter-installation',
    ...
    serviceFeatures: [
      {
        ...
        description:
          'Complete licensing, bonding, and insurance coverage for your protection and peace of mind.',
      },
      {
        icon: 'clock',
        title: 'Emergency Services',
        description:
          '24/7 emergency response for storm damage, leaks, and other urgent roofing issues.',
      },
      {
        icon: 'award',
        title: 'Master Elite Certified',
        description:
          'GAF Master Elite certification represents the top 3% of roofing contractors nationwide.',
      },
      {
        icon: 'users',
        title: 'Experienced Team',
        description:
          'Over 15 years of roofing experience with continuous training and certification updates.',
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Transform your kitchen with professional remodeling services. Custom designs, quality craftsmanship, and complete project management from planning to completion.',
    keywords: [
      'kitchen remodeling',
      'kitchen renovation',
      'custom kitchens',
...
We understand that kitchen renovations can be stressful, which is why we prioritize clear communication throughout the process. Regular updates, photo documentation, and prompt responses to questions help ensure you feel informed and comfortable every step of the way.`,
    shortDescription:
      'Complete kitchen remodeling services including design, cabinetry, countertops, flooring, and appliance installation.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'We discuss your vision, needs, and budget, then create detailed design plans with 3D renderings and material selections.',
        duration: '1-2 weeks',
      },
      {
        step: 2,
        ...
        description:
          'We obtain necessary permits and order all materials, ensuring everything is coordinated for efficient installation.',
        duration: '2-4 weeks',
      },
      {
        step: 3,
        ...
        description:
          'Careful removal of existing elements, protection of adjacent areas, and preparation of space for new installation.',
        duration: '1-2 days',
      },
      {
        step: 4,
        ...
        description:
          'Electrical, plumbing, and structural modifications are completed according to design specifications and local codes.',
        duration: '2-5 days',
      },
      {
        step: 5,
        ...
        description:
          'Cabinet installation, countertops, backsplash, flooring, appliances, and finishing touches are completed with precision.',
        duration: '1-2 weeks',
      },
      {
        step: 6,
        ...
        description:
          'Comprehensive quality inspection, cleanup, and detailed walkthrough to ensure your complete satisfaction.',
        duration: '1 day',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          'Most kitchen remodels take 4-8 weeks from start to finish, depending on the scope of work, custom elements, and material availability. We provide a detailed timeline during the planning phase.',
        category: 'timeline',
      },
      {
        question: 'Can I use my kitchen during the renovation?',
        answer:
          'We work to minimize disruption, but there will be periods when your kitchen is unusable. We help you plan temporary cooking arrangements and coordinate the work to minimize downtime.',
        category: 'logistics',
      },
      {
        question: 'Do you handle all the permits and inspections?',
        answer:
          'Yes, we handle all necessary permits, schedule required inspections, and ensure all work meets local building codes. This is included in our comprehensive project management.',
        category: 'permits',
      },
      {
        question: 'What if we discover unexpected issues during demolition?',
        answer:
          'We conduct thorough assessments before starting, but if unexpected issues arise, we discuss options and costs immediately. We never proceed with additional work without your approval.',
        category: 'problems',
      },
      {
        question: 'Can you work with my existing appliances?',
        answer:
          'Absolutely. We can design around existing appliances you want to keep, though we may recommend upgrades for better functionality or energy efficiency.',
        category: 'appliances',
      },
      {
        question: "What's included in your kitchen remodeling warranty?",
        answer:
          'We provide comprehensive warranties on workmanship (typically 2-5 years) plus manufacturer warranties on all materials, cabinets, countertops, and fixtures.',
        category: 'warranty',
      },
      {
        question: 'Do you offer financing for kitchen renovations?',
        answer:
          'Yes, we work with several financing partners to offer competitive rates and flexible terms. Many homeowners also use home equity loans or lines of credit.',
        category: 'financing',
      },
    ],
    callToActions: [
      {
        ...
        description:
          'Meet with our designers to explore possibilities for your kitchen transformation.',
      },
      {
        type: 'estimate',
    ...
    serviceFeatures: [
      {
        ...
        description:
          '3D design visualization and custom layout planning to maximize your space and functionality.',
      },
      {
        icon: 'tools',
        title: 'Complete Project Management',
        description:
          'We coordinate all trades, materials, and timelines for a seamless renovation experience.',
      },
      {
        icon: 'star',
        title: 'Premium Materials',
        description:
          'Access to high-quality cabinetry, countertops, and fixtures from trusted manufacturers.',
      },
      {
        icon: 'certificate',
        title: 'Licensed Professionals',
        description:
          'Licensed contractors, electricians, and plumbers ensure all work meets code requirements.',
      },
    ],
    ...
    materials: [
      ...
      'Tile Backsplash',
      'Hardwood/Luxury Vinyl Flooring',
      'LED Lighting',
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Professional bathroom renovation services including design, plumbing, tiling, and fixture installation. Transform your bathroom into a luxurious retreat.',
    keywords: [
      'bathroom remodeling',
      'bathroom renovation',
      'shower installation',
...
Modern bathroom design also emphasizes energy efficiency and water conservation. We can incorporate low-flow fixtures, LED lighting, efficient ventilation systems, and smart home features that reduce utility costs while improving comfort and convenience.`,
    shortDescription:
      'Complete bathroom renovation services including design, plumbing, tiling, fixtures, and accessibility modifications.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'We evaluate your current bathroom, discuss your vision and needs, and create design plans with material selections.',
        duration: '1-2 weeks',
      },
      {
        step: 2,
        ...
        description:
          'Detailed project planning, permit acquisition, and material ordering to ensure smooth project execution.',
        duration: '1-2 weeks',
      },
      {
        step: 3,
        ...
        description:
          'Careful removal of existing fixtures and finishes, with protection of surrounding areas and proper disposal.',
        duration: '1-2 days',
      },
      {
        step: 4,
        ...
        description:
          'Installation or modification of plumbing and electrical systems according to design specifications and building codes.',
        duration: '2-3 days',
      },
      {
        step: 5,
        title: 'Installation & Finishing',
        description:
          'Installation of new fixtures, tile work, vanity, lighting, and all finishing details with quality craftsmanship.',
        duration: '1-2 weeks',
      },
      {
        step: 6,
        title: 'Final Inspection & Cleanup',
        description:
          'Thorough quality inspection, complete cleanup, and final walkthrough to ensure your satisfaction.',
        duration: '1 day',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          'Most bathroom remodels take 2-4 weeks, depending on the scope of work and complexity. Simple updates may take 1-2 weeks, while complete renovations with custom work may take longer.',
        category: 'timeline',
      },
      {
        question: "Can you work around my family's schedule?",
        answer:
          'We work to minimize disruption to your routine. For homes with multiple bathrooms, we can often leave one functional. We discuss scheduling options during planning.',
        category: 'logistics',
      },
      {
        question: 'Do you handle waterproofing and moisture protection?',
        answer:
          'Absolutely. Proper waterproofing is critical in bathroom renovations. We use industry-best practices and materials to ensure long-term protection against moisture damage.',
        category: 'waterproofing',
      },
      {
        question: 'Can you make my bathroom more accessible?',
        answer:
          'Yes, we specialize in accessibility modifications including walk-in showers, grab bars, comfort-height toilets, and wider doorways to accommodate wheelchairs or walkers.',
        category: 'accessibility',
      },
      {
        question: 'What if we need to move plumbing or electrical?',
        answer:
          'We can relocate plumbing and electrical as needed for your design. Our licensed professionals ensure all work meets code requirements. Costs depend on the extent of modifications.',
        category: 'plumbing',
      },
      {
        question: 'Do you offer eco-friendly options?',
        answer:
          'Yes, we can incorporate water-efficient fixtures, LED lighting, sustainable materials, and improved ventilation systems that reduce environmental impact and utility costs.',
        category: 'sustainability',
      },
      {
        question: "What's included in your bathroom renovation warranty?",
        answer:
          'We provide workmanship warranties (typically 2-5 years) plus manufacturer warranties on fixtures, vanities, and materials. Specific terms are outlined in your contract.',
        category: 'warranty',
      },
    ],
    callToActions: [
      ...
      },
      {
        ...
        description:
          'Receive a detailed quote with design ideas and material options for your renovation.',
      },
      {
        type: 'form',
        text: 'Request Bathroom Ideas',
        description:
          'Tell us about your vision and receive inspiration and design tips for your project.',
      },
    ],
    relatedServices: [
      'kitchen-remodeling',
    ...
    serviceFeatures: [
      {
        ...
        description:
          'Professional waterproofing techniques and materials to prevent moisture damage and ensure longevity.',
      },
      {
        icon: 'wrench',
        title: 'Licensed Plumbing',
        description:
          'Licensed plumbers handle all fixture installation and plumbing modifications to code standards.',
      },
      {
        icon: 'accessibility',
        title: 'Accessibility Options',
        description:
          'ADA-compliant modifications for aging in place and improved accessibility for all users.',
      },
      {
        icon: 'energy',
        title: 'Energy Efficient',
        description:
          'Water-saving fixtures, LED lighting, and efficient ventilation to reduce utility costs.',
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Expand your living space with professional home additions. Room additions, second stories, and custom expansions designed to match your existing home.',
    keywords: [
      'home additions',
      'room additions',
...
We recognize that living in your home during construction can be challenging, which is why we focus on minimizing disruption to your daily routine. We work to maintain access to essential areas of your home and keep construction areas clean and secure.`,
    shortDescription:
      'Professional home additions including room additions, second stories, and custom expansions that integrate seamlessly with your existing home.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          "We assess your home's structure, discuss your needs, and determine the best approach for your addition project.",
        duration: '1-2 weeks',
      },
      {
        step: 2,
        ...
        description:
          'Detailed architectural plans, structural engineering, and design development to ensure seamless integration.',
        duration: '3-6 weeks',
      },
      {
        step: 3,
        ...
        description:
          'We handle all permit applications, engineering reviews, and municipal approvals required for your project.',
        duration: '4-8 weeks',
      },
      {
        step: 4,
        ...
        description:
          'Site preparation, excavation, and foundation work performed to exact specifications and building codes.',
        duration: '1-2 weeks',
      },
      {
        step: 5,
        ...
        description:
          'Complete framing, roofing, and structural work with proper integration to existing home systems.',
        duration: '2-4 weeks',
      },
      {
        step: 6,
        ...
        description:
          'Electrical, plumbing, HVAC, insulation, drywall, flooring, and finishing work completed to match existing home.',
        duration: '4-8 weeks',
      },
      {
        step: 7,
        ...
        description:
          'All final inspections, touch-up work, and project completion with comprehensive walkthrough.',
        duration: '1 week',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          'Home additions typically take 3-8 months, depending on size and complexity. Simple room additions may take 3-4 months, while second stories or complex additions may take 6-8 months.',
        category: 'timeline',
      },
      {
        question: 'Do I need to move out during construction?',
        answer:
          'Most homeowners can remain in their homes during addition construction. We work to minimize disruption and maintain access to essential areas. Specific arrangements depend on the project scope.',
        category: 'logistics',
      },
      {
        question: 'How do you match the existing architecture?',
        answer:
          "We carefully analyze your home's architectural style, materials, and proportions to ensure the addition complements the existing structure. We can match or thoughtfully contrast for the best result.",
        category: 'design',
      },
      {
        question: 'What permits are required for home additions?',
        answer:
          'Permits typically include building permits, electrical permits, and plumbing permits. We handle all permit applications and ensure compliance with local building codes and zoning requirements.',
        category: 'permits',
      },
      {
        question: 'Can you add a second story to any home?',
        answer:
          'Not all homes are suitable for second-story additions. We conduct structural assessments to determine feasibility and may recommend foundation reinforcement if needed.',
        category: 'structural',
      },
      {
        question: 'How much value does an addition add to my home?',
        answer:
          'Well-designed additions typically add 50-80% of their cost in home value, depending on the type of addition, quality of construction, and local market conditions.',
        category: 'value',
      },
      {
        question: 'Can you build an ADU (accessory dwelling unit)?',
        answer:
          'Yes, we build ADUs including basement apartments, garage conversions, and separate structures. We ensure compliance with local ADU regulations and zoning requirements.',
        category: 'adu',
      },
    ],
    callToActions: [
      ...
      },
      {
        ...
        description:
          'Receive a detailed estimate with design concepts for your home expansion project.',
      },
      {
        type: 'form',
        text: 'Request Addition Information',
        description:
          'Tell us about your vision and receive information about addition options and feasibility.',
      },
    ],
    relatedServices: [
      'foundation-services',
    ...
    serviceFeatures: [
      {
        ...
        description:
          'Expert design and construction that makes additions look like original parts of your home.',
      },
      {
        icon: 'ruler-combined',
        title: 'Custom Design',
        description:
          "Personalized design solutions that meet your specific needs and complement your home's architecture.",
      },
      {
        icon: 'document-check',
        title: 'Full Permit Service',
        description:
          'Complete permit handling and code compliance management throughout the construction process.',
      },
      {
        icon: 'cog',
        title: 'Complete Project Management',
        description:
          'Coordinated scheduling of all trades and materials for efficient, high-quality construction.',
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Custom deck construction and installation services. Composite, wood, and multi-level decks built to last with professional craftsmanship.',
    keywords: [
      'deck building',
      'deck construction',
      'composite decking',
...
Quality materials and expert craftsmanship ensure that your deck will provide years of enjoyment with minimal maintenance. We use only premium fasteners, hardware, and materials appropriate for outdoor use, and our construction techniques ensure proper water drainage and ventilation to prevent rot and structural issues.`,
    shortDescription:
      'Professional deck construction and installation services using quality materials and expert craftsmanship for long-lasting outdoor living spaces.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'We assess your property, discuss your vision and needs, and create preliminary design concepts with material options.',
        duration: '1 week',
      },
      {
        step: 2,
        ...
        description:
          'Final design development, structural planning, permit applications, and material ordering for your custom deck.',
        duration: '2-3 weeks',
      },
      {
        step: 3,
        title: 'Site Preparation & Foundation',
        description:
          'Site preparation, excavation, and installation of footings and foundation elements according to engineering specifications.',
        duration: '1-2 days',
      },
      {
        step: 4,
        title: 'Framing & Structure',
        description:
          'Installation of posts, beams, joists, and structural framework with proper hardware and fastening systems.',
        duration: '1-2 days',
      },
      {
        step: 5,
        ...
        description:
          'Installation of decking materials, railings, stairs, and any integrated features like built-in seating or planters.',
        duration: '2-3 days',
      },
      {
        step: 6,
        ...
        description:
          'Final finishing work, cleanup, inspection, and project completion with care instructions for your new deck.',
        duration: '1 day',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          "We recommend composite decking, cedar, or pressure-treated lumber based on your budget and maintenance preferences. Composite offers low maintenance, while cedar provides natural beauty. We'll help you choose the best option.",
        category: 'materials',
      },
      {
        question: 'How long does deck construction take?',
        answer:
          'Most decks take 1-2 weeks to complete, depending on size and complexity. Simple decks may be completed in a few days, while elaborate multi-level designs may take longer.',
        category: 'timeline',
      },
      {
        question: 'Do I need permits for deck construction?',
        answer:
          'Most deck projects require building permits. We handle all permit applications and ensure compliance with local building codes, setback requirements, and height restrictions.',
        category: 'permits',
      },
      {
        question: 'Can you add features like lighting or built-in seating?',
        answer:
          'Absolutely. We can integrate lighting systems, built-in benches, planters, pergolas, and other features into your deck design for enhanced functionality and aesthetics.',
        category: 'features',
      },
      {
        question: 'How do you ensure proper drainage?',
        answer:
          'We design decks with proper slope for water runoff, use appropriate spacing between boards, and ensure adequate ventilation underneath to prevent water damage and promote longevity.',
        category: 'drainage',
      },
      {
        question: 'What maintenance is required for different deck materials?',
        answer:
          'Composite decking requires minimal maintenance - just occasional cleaning. Wood decks need periodic staining or sealing. We provide specific maintenance guidelines for your chosen materials.',
        category: 'maintenance',
      },
      {
        question: 'Can you repair or replace existing decks?',
        answer:
          'Yes, we provide deck repair services and can replace deteriorating decks. We assess existing structures and recommend repair versus replacement based on safety and cost considerations.',
        category: 'repair',
      },
    ],
    callToActions: [
      {
        ...
        description:
          'Meet with our deck specialists to explore design options for your outdoor space.',
      },
      {
        type: 'estimate',
        text: 'Get Your Free Deck Estimate',
        description:
          'Receive a detailed quote with design concepts and material options for your custom deck.',
      },
      {
        type: 'form',
        text: 'Request Deck Information',
        description:
          'Tell us about your outdoor vision and receive design ideas and material recommendations.',
      },
    ],
    relatedServices: [
      'fence-installation',
    ...
    serviceFeatures: [
      {
        ...
        description:
          'Premium decking materials including composite, cedar, and pressure-treated options built to last.',
      },
      {
        icon: 'shield-check',
        title: 'Code Compliant',
        description:
          'All construction meets or exceeds local building codes with proper permits and inspections.',
      },
      {
        icon: 'palette',
        title: 'Custom Design',
        description:
          'Personalized deck designs that complement your home and meet your specific outdoor living needs.',
      },
      {
        icon: 'wrench',
        title: 'Expert Construction',
        description:
          'Professional construction techniques and quality hardware for structures built to withstand Utah weather.',
      },
    ],
    priceRange: '$15,000 - $40,000',
    timeline: '1-2 weeks',
  ...
  },
  {
    ...
    metaDescription:
      'Professional siding installation and replacement services. Vinyl, fiber cement, wood, and metal siding options with expert installation.',
    keywords: [
      'siding installation',
      'siding replacement',
      'vinyl siding',
...
Energy efficiency is an important consideration in modern siding installations. We can incorporate insulated siding systems, improved vapor barriers, and proper ventilation techniques that enhance your home's thermal performance and reduce energy costs.`,
    shortDescription:
      'Professional siding installation and replacement services using quality materials and expert techniques for lasting protection and beauty.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          "We inspect your current siding, assess your home's needs, and help you select the best siding material and style.",
        duration: '1 week',
      },
      {
        step: 2,
        title: 'Detailed Estimate & Planning',
        description:
          'Comprehensive measurement, detailed estimate, material ordering, and project timeline development.',
        duration: '1-2 weeks',
      },
      {
        step: 3,
        ...
        description:
          'Protection of landscaping and property, removal of existing siding, and preparation of wall surfaces.',
        duration: '1-2 days',
      },
      {
        step: 4,
        ...
        description:
          'Installation of house wrap, vapor barriers, and any necessary repairs to sheathing or structural elements.',
        duration: '1 day',
      },
      {
        step: 5,
        ...
        description:
          'Professional installation of siding, trim work, and accessories using manufacturer-approved techniques.',
        duration: '3-7 days',
      },
      {
        step: 6,
        title: 'Final Inspection & Cleanup',
        description:
          'Quality inspection, touch-up work, complete cleanup, and walkthrough with warranty documentation.',
        duration: '1 day',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          'Fiber cement and vinyl siding perform exceptionally well in Utah. Fiber cement offers superior durability and fire resistance, while vinyl provides low maintenance and good value. We help you choose based on your priorities.',
        category: 'materials',
      },
      {
        question: 'How long does siding installation take?',
        answer:
          'Most homes take 5-10 days for complete siding installation, depending on size and complexity. Weather conditions and material availability can affect the timeline.',
        category: 'timeline',
      },
      {
        question: 'Can you match existing siding for additions or repairs?',
        answer:
          "We work to match existing siding as closely as possible for repair work. For additions, we help you choose complementary options if exact matches aren't available.",
        category: 'matching',
      },
      {
        question: 'Do you handle insurance claims for storm damage?',
        answer:
          'Yes, we work directly with insurance companies and adjusters to document damage, provide estimates, and ensure proper claim processing for storm-damaged siding.',
        category: 'insurance',
      },
      {
        question: 'What maintenance is required for different siding types?',
        answer:
          'Vinyl requires occasional washing, fiber cement may need periodic painting, wood needs regular staining or painting, and metal requires minimal maintenance. We provide specific care instructions.',
        category: 'maintenance',
      },
      {
        question: 'Can siding installation improve energy efficiency?',
        answer:
          "Yes, new siding installation often includes improved house wrap, vapor barriers, and insulation that significantly enhance your home's energy efficiency.",
        category: 'efficiency',
      },
      {
        question: 'What warranty coverage do you provide?',
        answer:
          'We provide workmanship warranties (typically 5-10 years) plus manufacturer warranties on materials. Specific warranty terms depend on the siding material chosen.',
        category: 'warranty',
      },
    ],
    callToActions: [
      {
        ...
        description:
          'Get expert advice on the best siding options for your home and local climate.',
      },
      {
        type: 'estimate',
        text: 'Get Your Free Siding Estimate',
        description:
          'Receive a detailed estimate with material options and installation timeline for your project.',
      },
      {
        type: 'form',
        text: 'Request Siding Information',
        description:
          'Learn more about siding options and receive personalized recommendations for your home.',
      },
    ],
    relatedServices: [
      'roofing-residential',
    ...
    serviceFeatures: [
      {
        ...
        description:
          "Superior protection against Utah's diverse weather conditions including wind, hail, and temperature extremes.",
      },
      {
        icon: 'energy',
        title: 'Energy Efficiency',
        description:
          "Modern installation techniques and materials that improve your home's thermal performance.",
      },
      {
        icon: 'palette',
        title: 'Style Options',
      ...
      },
      {
        ...
        description:
          'Manufacturer-certified installation techniques that ensure optimal performance and warranty coverage.',
      },
    ],
    ...
    certifications: [
      ...
      'Utah Licensed Contractor',
      'Industry Training Certified',
    ],
  },
  {
    ...
    metaDescription:
      'Professional window replacement and installation services. Energy-efficient windows with expert installation for improved comfort and savings.',
    keywords: [
      'window replacement',
      'window installation',
      'energy efficient windows',
...
Energy efficiency is a primary consideration for most homeowners considering window replacement. Modern windows can significantly reduce energy costs while improving comfort by eliminating drafts, reducing outside noise, and providing better temperature control throughout your home.`,
    shortDescription:
      'Professional window replacement and installation services with energy-efficient options for improved comfort and energy savings.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'We evaluate your current windows, discuss your needs and preferences, and recommend the best window options.',
        duration: '1-2 hours',
      },
      {
        step: 2,
        ...
        description:
          'Precise measurement of all window openings and ordering of custom-sized windows from our trusted manufacturers.',
        duration: '3-6 weeks',
      },
      {
        step: 3,
        ...
        description:
          'Protection of interior spaces and preparation of work areas for efficient window replacement.',
        duration: '1 day',
      },
      {
        step: 4,
        title: 'Professional Installation',
        description:
          'Expert removal of old windows and installation of new windows with proper insulation and weatherproofing.',
        duration: '1-3 days',
      },
      {
        step: 5,
        ...
        description:
          'Interior and exterior trim work, caulking, cleanup, and final inspection to ensure quality completion.',
        duration: '1 day',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          'Energy savings vary but typically range from 10-25% on heating and cooling costs. Actual savings depend on your current windows, home insulation, and chosen window efficiency ratings.',
        category: 'savings',
      },
      {
        question: 'What window materials work best in Utah?',
        answer:
          "Vinyl and fiberglass windows perform exceptionally well in Utah's climate. They resist temperature extremes, require minimal maintenance, and offer excellent energy efficiency.",
        category: 'materials',
      },
      {
        question: 'How long does window replacement take?',
        answer:
          'Most homes take 1-3 days for complete window replacement, depending on the number of windows and any complications. Each window typically takes 30-60 minutes to install.',
        category: 'timeline',
      },
      {
        question: 'Can you install windows in winter?',
        answer:
          'Yes, we install windows year-round. We work quickly and use temporary coverings to minimize heat loss during winter installations.',
        category: 'weather',
      },
      {
        question: 'What warranty coverage do new windows include?',
        answer:
          'Most quality windows include 10-20 year warranties on materials and hardware, plus our installation warranty. Specific terms vary by manufacturer and product line.',
        category: 'warranty',
      },
      {
        question: 'Do I need permits for window replacement?',
        answer:
          "Most window replacements don't require permits if you're replacing existing windows with similar sizes. We handle any necessary permits if structural changes are involved.",
        category: 'permits',
      },
      {
        question: 'Can you match my existing window styles?',
        answer:
          'We offer a wide variety of styles, colors, and configurations. We work to match existing architecture or help you choose complementary options for the best appearance.',
        category: 'styles',
      },
    ],
    callToActions: [
      {
        ...
        description:
          "Get expert advice on the best window options for your home's needs and budget.",
      },
      {
        type: 'estimate',
        text: 'Get Your Free Window Estimate',
        description:
          'Receive a detailed quote with energy efficiency calculations and product options.',
      },
      {
        type: 'form',
    ...
    serviceFeatures: [
      {
        ...
        title: 'Energy Efficient',
        description:
          'High-performance windows with Low-E coatings and advanced insulation for maximum energy savings.',
      },
      {
        icon: 'shield-check',
        title: 'Quality Installation',
        description:
          'Certified installation techniques ensuring proper fit, insulation, and weatherproofing.',
      },
      {
        icon: 'home',
        title: 'Enhanced Comfort',
        description:
          'Eliminate drafts, reduce noise, and improve temperature control throughout your home.',
      },
      {
        icon: 'award',
        title: 'Trusted Brands',
        description:
          'Premium windows from leading manufacturers with comprehensive warranty coverage.',
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Professional flooring installation including hardwood, laminate, vinyl, tile, and carpet. Expert installation with quality materials and warranties.',
    keywords: [
      'flooring installation',
      'hardwood flooring',
...
We understand that flooring installation can disrupt your daily routine, which is why we focus on efficient project completion with minimal inconvenience. We work clean, protect your belongings, and coordinate with your schedule to complete installations as quickly as possible while maintaining our quality standards.`,
    shortDescription:
      'Expert flooring installation services for all flooring types including hardwood, laminate, vinyl, tile, and carpet with professional craftsmanship.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'We assess your spaces, discuss your needs and preferences, and help you select the best flooring options.',
        duration: '1-2 days',
      },
      {
        step: 2,
        title: 'Measurement & Ordering',
        description:
          'Precise measurement of all areas and ordering of materials with appropriate waste factors and accessories.',
        duration: '1-2 weeks',
      },
      {
        step: 3,
        ...
        description:
          'Removal of existing flooring, subfloor assessment and preparation, and protection of adjacent areas.',
        duration: '1-2 days',
      },
      {
        step: 4,
        title: 'Professional Installation',
        description:
          'Expert installation using appropriate techniques, tools, and materials for your specific flooring type.',
        duration: '1-5 days',
      },
      {
        step: 5,
        title: 'Finishing & Cleanup',
        description:
          'Installation of transition strips, baseboards, and trim work, plus thorough cleanup and final inspection.',
        duration: '1 day',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          'Luxury vinyl plank, engineered hardwood, and ceramic tile perform exceptionally well in high-traffic areas. They offer durability, easy maintenance, and attractive appearance.',
        category: 'materials',
      },
      {
        question: 'How long does flooring installation take?',
        answer:
          'Installation time varies by flooring type and room size. Most rooms take 1-3 days, while whole-house installations may take 1-2 weeks depending on the scope.',
        category: 'timeline',
      },
      {
        question: 'Can you install flooring over existing floors?',
        answer:
          'Some flooring types can be installed over existing floors if conditions are suitable. We assess each situation and recommend the best approach for optimal results.',
        category: 'installation',
      },
      {
        question: 'What about moisture issues in basements or bathrooms?',
        answer:
          'We use appropriate moisture barriers and select flooring materials suitable for moisture-prone areas. Luxury vinyl and tile are excellent choices for these spaces.',
        category: 'moisture',
      },
      {
        question: 'Do you move furniture during installation?',
        answer:
          'We can move most furniture as part of our service. Heavy items or valuable pieces may require special arrangements, which we discuss during planning.',
        category: 'logistics',
      },
      {
        question: 'What maintenance is required for different flooring types?',
        answer:
          'Maintenance varies significantly by material. We provide specific care instructions and recommend appropriate cleaning products for your chosen flooring.',
        category: 'maintenance',
      },
      {
        question: 'Can you match existing flooring for additions or repairs?',
        answer:
          'We work to match existing flooring as closely as possible. For older or discontinued products, we help you choose complementary options for seamless transitions.',
        category: 'matching',
      },
    ],
    callToActions: [
    ...
    serviceFeatures: [
      {
        ...
        description:
          'Complete selection of hardwood, laminate, vinyl, tile, and carpet with expert installation for each.',
      },
      {
        icon: 'level',
        title: 'Proper Preparation',
        description:
          'Thorough subfloor assessment and preparation ensuring optimal performance and longevity.',
      },
      {
        icon: 'star',
        title: 'Quality Materials',
        description:
          'Premium flooring materials from trusted manufacturers with comprehensive warranty coverage.',
      },
      {
        icon: 'clock',
        title: 'Efficient Installation',
        description:
          'Professional installation techniques that minimize disruption and complete projects on schedule.',
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Professional plumbing services including repairs, installations, and maintenance. Licensed plumbers for all residential plumbing needs.',
    keywords: [
      'plumbing services',
      'plumber',
      'plumbing repair',
...
Water efficiency and conservation are increasingly important considerations for modern plumbing systems. We can recommend and install water-efficient fixtures, tankless water heaters, and other technologies that reduce water usage while maintaining excellent performance.`,
    shortDescription:
      'Licensed professional plumbing services including repairs, installations, maintenance, and emergency services for all residential needs.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'Our licensed plumber evaluates your plumbing issue, identifies the root cause, and explains the problem and solution options.',
      ...
      },
      {
        ...
        description:
          'We provide detailed estimates for repair or installation work, including materials, labor, and timeline information.',
        duration: 'Same visit',
      },
      {
        step: 3,
        ...
        description:
          'Expert plumbing work using quality materials and proper techniques, following all applicable codes and standards.',
      ...
      },
      {
        ...
        description:
          'Thorough testing of repairs, cleanup of work areas, and explanation of any maintenance recommendations.',
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, we offer emergency plumbing services for urgent issues like major leaks, sewer backups, and water heater failures. Contact us immediately for emergency situations.',
        category: 'emergency',
      },
      {
        question: 'Are your plumbers licensed and insured?',
        answer:
          'Absolutely. All our plumbers are fully licensed by the state of Utah and we carry comprehensive insurance coverage for your protection.',
        category: 'licensing',
      },
      {
        question: 'What types of water heaters do you install?',
        answer:
          'We install and service all types of water heaters including traditional tank units, tankless systems, and hybrid heat pump models. We help you choose the best option for your needs.',
        category: 'water-heaters',
      },
      {
        question: 'Can you help with low water pressure issues?',
        answer:
          'Yes, we diagnose and resolve water pressure problems which can be caused by various issues including pipe blockages, pressure regulators, or municipal supply problems.',
        category: 'pressure',
      },
      {
        question: 'Do you offer warranties on plumbing work?',
        answer:
          'Yes, we provide warranties on our workmanship (typically 1-2 years) plus manufacturer warranties on parts and fixtures. Specific warranty terms are explained before work begins.',
        category: 'warranty',
      },
      {
        question: 'Can you work on older plumbing systems?',
        answer:
          'Absolutely. We have extensive experience with both modern and older plumbing systems, including copper, galvanized steel, and cast iron piping.',
        category: 'older-systems',
      },
      {
        question: 'What should I do if I have a plumbing emergency?',
        answer:
          'Turn off the main water supply if possible, contact us immediately, and avoid using affected fixtures. We provide emergency guidance over the phone while dispatching a plumber.',
    ...
    callToActions: [
      {
        ...
        description:
          'Plumbing emergency? Call now for immediate assistance from our licensed plumbers.',
        urgency: 'Available 24/7',
      },
      {
        type: 'estimate',
        ...
        description:
          'Schedule a plumbing assessment and receive a detailed estimate for your project.',
      },
      {
        type: 'form',
        text: 'Request Plumbing Service',
        description:
          'Describe your plumbing issue and schedule service with our professional team.',
      },
    ],
    relatedServices: [
      'bathroom-remodeling',
    ...
    serviceFeatures: [
      {
        ...
        title: 'Licensed Professionals',
        description:
          'Fully licensed, experienced plumbers providing reliable service and quality workmanship.',
      },
      {
        icon: 'clock',
        title: 'Emergency Service',
        description:
          '24/7 emergency plumbing services for urgent repairs and water damage prevention.',
      },
      {
        icon: 'shield-check',
        title: 'Quality Guaranteed',
        description:
          'Premium materials, professional installation, and comprehensive warranties on all work.',
      },
      {
        icon: 'dollar-sign',
        title: 'Transparent Pricing',
        description:
          'Upfront estimates with no hidden fees and competitive pricing for all plumbing services.',
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Professional electrical services including repairs, installations, panel upgrades, and safety inspections by licensed electricians.',
    keywords: [
      'electrical services',
      'electrician',
      'electrical repair',
...
Modern homes have significantly higher electrical demands than older electrical systems were designed to handle. We can assess your electrical capacity and recommend upgrades that safely accommodate modern appliances, electronics, and lifestyle needs while improving energy efficiency and convenience.`,
    shortDescription:
      'Licensed professional electrical services including repairs, installations, panel upgrades, and safety inspections for all residential needs.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'Our licensed electrician evaluates your electrical issue or needs, tests systems, and identifies the best solution approach.',
        duration: '30-60 minutes',
      },
      {
        step: 2,
        ...
        description:
          'Detailed estimate with safety considerations, code requirements, and timeline for completing the electrical work.',
        duration: 'Same visit',
      },
      {
        step: 3,
        ...
        description:
          'Expert electrical work using quality materials and proper techniques, following all safety protocols and electrical codes.',
        duration: 'Varies by project',
      },
      {
        step: 4,
        ...
        description:
          'Thorough testing of all electrical work, cleanup, and documentation of completed work for your records.',
        duration: '15-30 minutes',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          "Consider upgrading if your panel is over 20 years old, frequently trips breakers, has fuses instead of breakers, or can't handle your electrical demands. We provide free assessments.",
        category: 'panels',
      },
      {
        question: 'Are your electricians licensed and insured?',
        answer:
          "Yes, all our electricians are fully licensed by the state of Utah and we carry comprehensive insurance coverage including liability and workers' compensation.",
        category: 'licensing',
      },
      {
        question: 'Do you provide emergency electrical services?',
        answer:
          'Yes, we offer emergency electrical services for safety hazards like sparking outlets, burning smells, or complete power loss. Contact us immediately for emergencies.',
        category: 'emergency',
      },
      {
        question: 'Can you install whole-house surge protection?',
        answer:
          'Absolutely. Whole-house surge protectors protect all your electronics and appliances from power surges. We install quality units at your electrical panel.',
        category: 'surge-protection',
      },
      {
        question: "What's involved in adding new outlets or circuits?",
        answer:
          'New circuits require running wire from your panel to the new location, installing outlets or switches, and ensuring proper circuit protection. We handle permits when required.',
        category: 'new-circuits',
      },
      {
        question: 'How do I know if my electrical system is safe?',
        answer:
          'Warning signs include frequent breaker trips, flickering lights, warm outlets, burning smells, or shocks from appliances. We offer comprehensive electrical safety inspections.',
        category: 'safety',
      },
      {
        question: 'Can you install smart home electrical components?',
        answer:
          'Yes, we install smart switches, outlets, thermostats, and other connected devices. We ensure proper wiring and compatibility with your electrical system.',
        category: 'smart-home',
      },
    ],
    callToActions: [
      {
        ...
        description:
          'Electrical emergency or safety concern? Call immediately for urgent electrical assistance.',
        urgency: 'Available 24/7',
      },
      {
        type: 'estimate',
        ...
        description:
          'Schedule an electrical assessment and receive a detailed estimate for your project.',
      },
      {
        type: 'consultation',
        text: 'Request Electrical Safety Inspection',
        description:
          'Get a comprehensive electrical safety inspection to identify potential hazards.',
      },
    ],
    relatedServices: [
      'panel-upgrades',
    ...
    serviceFeatures: [
      {
        ...
        description:
          'Master electricians with extensive training and experience in all aspects of residential electrical work.',
      },
      {
        icon: 'shield',
        title: 'Safety First',
        description:
          'Strict safety protocols and code compliance to protect your family and property from electrical hazards.',
      },
      {
        icon: 'clock',
        title: 'Emergency Service',
        description:
          '24/7 emergency electrical services for urgent safety issues and power problems.',
      },
      {
        icon: 'award',
        title: 'Quality Components',
        description:
          'Premium electrical components and materials from trusted manufacturers with comprehensive warranties.',
      },
    ],
    ...
    certifications: [
      'Utah Licensed Master Electrician',
      'Insured and Bonded',
      'Continuing Education Certified',
    ],
  },
  {
    ...
    title: 'HVAC Services',
    metaDescription:
      'Professional HVAC services including installation, repair, and maintenance of heating and cooling systems by licensed technicians.',
    keywords: [
      'HVAC services',
      'heating and cooling',
      'furnace repair',
...
Regular maintenance is essential for HVAC system performance, efficiency, and longevity. Our maintenance programs help prevent costly breakdowns, maintain manufacturer warranties, and ensure your system operates at peak efficiency throughout its lifespan.`,
    shortDescription:
      'Professional HVAC services including heating and cooling system installation, repair, maintenance, and indoor air quality solutions.',
    benefits: [
    ...
    process: [
      {
        ...
        description:
          'Our licensed HVAC technician evaluates your system, diagnoses issues, and recommends the best solution approach.',
      ...
      },
      {
        ...
        description:
          'Detailed estimate with system options, efficiency considerations, and timeline for completing the HVAC work.',
        duration: 'Same visit',
      },
      {
        step: 3,
        ...
        description:
          'Expert HVAC work using quality components and proper techniques, following all safety protocols and manufacturer specifications.',
        duration: 'Varies by project',
      },
      {
        step: 4,
        ...
        description:
          'Thorough system testing, performance verification, and optimization for maximum efficiency and comfort.',
        duration: '30-60 minutes',
      },
    ],
    problemsSolved: [
    ...
    faqs: [
      {
        ...
        answer:
          'We recommend annual maintenance for optimal performance - typically spring for cooling systems and fall for heating systems. Regular maintenance prevents problems and maintains efficiency.',
        category: 'maintenance',
      },
      {
        question: 'When should I consider replacing my HVAC system?',
        answer:
          "Consider replacement if your system is over 10-15 years old, requires frequent repairs, has rising energy costs, or can't maintain comfortable temperatures consistently.",
        category: 'replacement',
      },
      {
        question: 'Are your HVAC technicians licensed and certified?',
        answer:
          'Yes, all our HVAC technicians are fully licensed and certified in Utah. They receive ongoing training on the latest technologies and efficiency standards.',
        category: 'licensing',
      },
      {
        question: 'Do you provide emergency HVAC services?',
        answer:
          'Yes, we offer emergency HVAC services for urgent comfort issues, especially during extreme weather conditions when system failures can be dangerous.',
        category: 'emergency',
      },
      {
        question: "Can you improve my home's indoor air quality?",
        answer:
          'Absolutely. We offer air filtration systems, humidity control, UV lights, and ventilation improvements that significantly enhance indoor air quality.',
        category: 'air-quality',
      },
      {
        question: 'What size HVAC system do I need for my home?',
        answer:
          'System sizing depends on home size, insulation, windows, orientation, and other factors. We perform load calculations to determine the optimal system size for efficiency and comfort.',
        category: 'sizing',
      },
      {
        question: 'Do you offer financing for HVAC system replacement?',
        answer:
          'Yes, we work with financing partners to offer competitive rates and flexible terms for HVAC system replacement and major repairs.',
        category: 'financing',
      },
    ],
    callToActions: [
      ...
      },
      {
        ...
        description:
          'Schedule an HVAC assessment and receive a detailed estimate for your comfort needs.',
      },
      {
        type: 'form',
        text: 'Request HVAC Maintenance',
        description:
          'Schedule preventive maintenance to keep your HVAC system running efficiently.',
      },
    ],
    relatedServices: [
    ...
    serviceFeatures: [
      {
        ...
        description:
          "Extensive experience with Utah's climate challenges and optimal HVAC solutions for local conditions.",
      },
      {
        icon: 'leaf',
        title: 'Energy Efficient',
        description:
          'High-efficiency HVAC systems and optimization techniques to minimize energy costs.',
      },
      {
        icon: 'clock',
        title: 'Emergency Service',
      ...
      },
      {
        ...
        description:
          'Full-service HVAC including heating, cooling, ventilation, and indoor air quality solutions.',
      },
    ],
...
export function getLocationSpecificContent(
  ...
  return {
    ...baseContent,
    metaDescription: baseContent.metaDescription.replace(/Utah|Salt Lake City/g, cityName),
    keywords: locationKeywords,
    longDescription: baseContent.longDescription.replace(/Utah/g, `${cityName}, ${stateAbbrev}`),
  };
}
...
export function searchServiceContent(query: string): ServiceContentData[] {
  ...
  return serviceContentData.filter(
    (service) =>
