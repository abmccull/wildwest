...
export const MobileConversionBar: React.FC = () => {
  ...
  return (
    <>
        ...
        {!showQuickForm ? (
          <div className="grid grid-cols-2 gap-2 p-3">
            <a
              ...
              className="bg-green-600 text-white rounded-lg py-3 text-center font-medium flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="bg-blue-600 text-white rounded-lg py-3 font-medium animate-pulse"
            >
              {getMessage()}
            </button>
          </div>
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => setShowQuickForm(false)} className="text-gray-400">
                ✕
              </button>
            </div>
      ...
      <div className="fixed right-4 bottom-20 flex flex-col gap-3 md:hidden">
        {/* Chat Button */}
