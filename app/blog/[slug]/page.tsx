...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const relatedPosts = post.related_posts
    ? JSON.parse(post.related_posts as string)
    : [];

  // Increment view count (fire and forget)
  const supabase = await createServerClient();
  await supabase.rpc("increment_blog_post_views", { post_uuid: post.id });
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 p-8 bg-gradient-to-r from-blue-800 to-blue-900 rounded-lg text-white text-center">
              ...
              <p className="text-blue-100 mb-6">
                Our professional team is ready to help with all your flooring,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image:
              post.featured_image ||
              "https://wildwestslc.com/images/og-image.jpg",
            author: {
              "@type": "Organization",
              name: post.author,
            },
