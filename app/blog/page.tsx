          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 max-w-3xl mx-auto">
                Expert insights, tips, and guides from Utah&apos;s trusted construction professionals. 
                Learn about flooring, demolition, junk removal, and home improvement.
              </p>
            </div>
          </div>
        </section>
            ...
            {(category || search) && (
              <div className="mb-8 text-center">
                <p className="text-gray-600">
                  {search ? `Search results for "${search}"` : `Showing ${categories.find(c => c.slug === category)?.name || category} posts`}
                  {totalCount > 0 && ` (${totalCount} ${totalCount === 1 ? 'post' : 'posts'})`}
                </p>
              </div>
            )}
        ...
        <section className="bg-gray-50 py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Our expert team is ready to help with all your flooring, demolition, and junk removal needs throughout Utah.
            </p>
